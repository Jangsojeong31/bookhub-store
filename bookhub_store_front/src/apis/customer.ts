...
// 회원 정보 불러오기 (이메일, 전화번호)
export const getCustomerInfo = async (accessToken: string): Promise<ResponseDto<CustomerInfoResponseDto>> => {
  try {
...
// 회원 정보 수정
export const updateCustomerInfo = async (dto: UpdateCustomerInfoRequestDto, accessToken: string): Promise<ResponseDto<void>> => {
  try {
...
// 비밀번호 수정
export const updatePassword = async (dto: UpdatePasswordRequestDto, accessToken: string): Promise<ResponseDto<void>> => {
  try {
    const response = await axiosInstance.put(
...
// 프로필 이미지 수정
export const updateProfileImage = async (dto: UpdateProfileImageRequestDto, accessToken: string): Promise<ResponseDto<void>> => {
  try {
    const response = await axiosInstance.put(
...
// 닉네임 변경
export const updateNickname = async (dto: UpdateNicknameRequestDto, accessToken: string): Promise<ResponseDto<void>> => {
  try {
    const response = await axiosInstance.put(
