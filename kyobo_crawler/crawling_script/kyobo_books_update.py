...
# 각 책 아이템 선택
book_elements = driver.find_elements(By.CSS_SELECTOR, "li.prod_item")
book_elements = book_elements[:5]   # 5권
book_links = []

for book in book_elements:
    try:
        link_elem = book.find_element(By.CSS_SELECTOR, 'div.prod_thumb_box a.prod_link')
