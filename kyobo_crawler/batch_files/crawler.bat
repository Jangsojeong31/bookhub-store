...
REM 로그 폴더 생성
if not exist "C:\장소정\북허브_스토어\kyobo_crawler\logs" mkdir "C:\장소정\북허브_스토어\kyobo_crawler\logs"
...
REM 스크립트 경로
set SCRIPT=C:\장소정\북허브_스토어\kyobo_crawler\crawling_script\kyobo_books_update.py
